    ...
    var jqeditor = function (textarea, options) {
        ...
        this.init = function () {
            ...
            $ctrl.after($('<input type="text" id="' + cursorID + '" style="position:absolute;display:none;" /><span id="' + boxID
                ...
                + '" class="eIframeArea" role="presentation"><div class="allbox"><div class="text_left"><iframe frameborder="0" id="' + iframeID
                + '" src="javascript:;" style="width:100%;"></iframe></div><div class="sentbtn"><input class="icon_btn" id="btnSend" type="button" value="发送"/></div></div></td></tr></table></span>'));
            ...
            try {
                $($('#' + iframeID)[0].contentWindow).focusout(function () {
