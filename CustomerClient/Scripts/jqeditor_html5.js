    ...
    var jqeditor = function (textarea, options) {
        ...
        this.init = function () {
            ...
            $ctrl.after($('<input type="text" id="' + cursorID + '" style="position:absolute;display:none;" /><span id="' + boxID
                + '" class="jqeditor" style="display:none"><table cellspacing="0" cellpadding="0" class="eLayout" style="width_del:' + editorWidth
                ...
                + '" class="eIframeArea" role="presentation"><div class="allbox"><div class="text_left"><div frameborder="0" id="' + iframeID
                + '" src="javascript:;" style="width:100%;" contenteditable="true"></div></div><div class="sentbtn"><input class="icon_btn" id="btnSend" type="button" value="发送"/></div></div></td></tr></table></span>'));
        ...
        this.showUpload = function () {
            ...
            var jUpload = $('<span class="eUpload"><form id="upform1" ><div>[注]:仅支持上传jpg,png,bmp文件(小于2M)</div><div><input type="file" class="eFile" name="fileData" tabindex="-1" /><input type="button" value="确定" class="eBtn" tabindex="-1" /></div></form></span>');
