<%@ Page Title="" Language="C#" MasterPageFile="~/Statics/Content.Master" AutoEventWireup="true" CodeBehind="TFNDNISView.aspx.cs" Inherits="Tele.Management.Pages.Voice.TFNDNIS.TFNDNISView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="navigator">
        <ul>
            <li>当前位置：</li>
            <li><a href="DNISList.aspx">大号与小号关系</a></li>
            <li>-</li>
            <li>
