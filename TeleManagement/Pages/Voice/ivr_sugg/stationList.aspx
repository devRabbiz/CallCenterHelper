<%@ Page Title="" Language="C#" MasterPageFile="~/Statics/Content.Master" AutoEventWireup="true" CodeBehind="stationList.aspx.cs" Inherits="Tele.Management.Pages.Voice.ivr_sugg.stationList" %>
    ...
    <div class="formDiv">
        ...
        <table class="searchTable">
            <tr>
                <td>区号</td>
                <td>
                    <asp:TextBox ID="txtAGENCY_COVER_AREA" runat="server"></asp:TextBox></td>
                <td>产线</td>
                <td>
            ...
            <tr>
                <td colspan="4" align="right">
                    ...
                    &nbsp;&nbsp;
                    <input type="button" class="btn100" onclick="self.location = 'stationView.aspx';"
                        value="新增" />
                    &nbsp;&nbsp;
                    <input type="button" class="btn100" onclick="self.location = '../../Public/FileUpload.aspx?docid=XltStation';"
                        value="导入" />
                </td>
            </tr>
        </table>
            ...
            <ItemTemplate>
                <tr class="item">
                    ...
                    <td>
                        ...
                        &nbsp;&nbsp;
                            <a href='stationView.aspx?id=<%#Eval("AGENCY_ID").ToString().Trim() %>,<%#Eval("PRODUCT_TYPE") %>'>编辑</a>
                    </td>
                </tr>
            </ItemTemplate>
