<%@ Page Title="" Language="C#" MasterPageFile="~/Statics/Content.Master" AutoEventWireup="true" CodeBehind="agencyView.aspx.cs" Inherits="Tele.Management.Pages.Voice.ivr_sugg.agencyView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="formDiv">
        ...
        <table class="searchTable">
            <tr>
                <td class="colLable">代理商编号<span>*</span></td>
                <td>
